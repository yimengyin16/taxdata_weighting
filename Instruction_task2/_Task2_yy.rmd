...
source(here::here("Instruction_task2", "libraries_yy.r"))
source(here::here("Instruction_task2", "functions_yy.r"))
source(here::here("Instruction_task2", "functions_optimization_yy.r"))
...
# verify that our wrapper works
simann2 <- opt_wrapper(wts0, sampdata, consdata, method="simann", objfn=objfn, maxiter=5000)
str(simann2)
...
mnl1 <- multinom(frm,
                ...
                maxit=1000)
str(nn1)
cbind(nn1$fitted.values, rowSums(nn1$fitted.values)) %>% ht # verify that probabilities sum to 1 on each record
