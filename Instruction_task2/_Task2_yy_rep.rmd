...
system.time(persons_all <- readRDS(paste0(destdir, 'persons.rds')))
glimpse(persons_all)
ns(persons_all)
...
sampdata_aug <- sampdata %>% mutate(wts_mma = wts_mma1, 
...
objfn(wts_NY, sampdata, consdata)
