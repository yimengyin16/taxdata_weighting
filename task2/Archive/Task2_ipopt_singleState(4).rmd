...
comparison <- 
  bind_rows(
    wtd.quantile(datause_[[var_]], datause_$pwgtp, pts),                                      # w/ original weight
    wtd.quantile(data_single_state[[var_]], data_single_state$pwgtp_original, pts), # target
    wtd.quantile(datause_[[var_]], datause_$pwgtp_rewgt, pts)                       # reweighted
) %>% 
  mutate(var  = var_, 
...
ecdf_org <- wtd.Ecdf(datause_[[var_]], datause_$pwgtp)
ecdf_tgt <- wtd.Ecdf(data_single_state[[var_]], data_single_state$pwgtp_original)
ecdf_rwt <- wtd.Ecdf(datause_[[var_]], datause_$pwgtp_rewgt)
